...
const Sidebar = ({ isAdmin, onNavigate }) => {
  const primaryMenuItems = [
    { key: 'dashboard', label: 'Dashboard', icon: '🏠', to: '/dashboard', type: 'placeholder' },
    ...
    { key: 'career', label: 'Career Guidance', icon: '🎯',to: '/', type: 'route' }
  ];
      ...
      <div className="sidebar-logo-section">
        <div className="sidebar-logo-wrap">
          <div className="sidebar-logo-circle">
            <img src="/images/logo.jpeg" alt="UniWell Logo" className="sidebar-logo-img" />
          </div>
